...
TARGETS = [
    ...
    (NB_04, "Chapter_04_Control_Structures_Conditionals_and_Loops.ipynb"),
    (NB_05, "Chapter_05_First_Python_Script.ipynb"),
    (NB_06, "Chapter_06_Integer_Mastery_for_VLSI.ipynb"),
    (NB_07, "Chapter_07_String_Mastery_for_VLSI.ipynb"),
    (NB_08, "Chapter_08_List_Mastery_for_VLSI.ipynb"),
    (NB_09, "Chapter_09_Dictionary_Mastery_for_VLSI.ipynb"),
    (NB_10, "Chapter_10_Tuple_Mastery_for_VLSI.ipynb"),
    (NB_11, "Chapter_11_Set_Mastery_for_VLSI.ipynb"),
    (NB_12, "Chapter_12_Functions_and_Modules_for_VLSI.ipynb"),
    (NB_13, "Chapter_13_File_IO_Operations_for_VLSI.ipynb"),
    (NB_14, "Chapter_14_Advanced_File_Processing_for_VLSI.ipynb"),
]
